...
class Survey:
    ...
    def __init__(self, title, instructions, questions):
        ...
        self.survey_length = len(questions)

class SurveyResponse:
    """Individual responses to a survey"""

    def __init__(self, survey_title):
...
surveys = {
    ...
    "duplicate": bad_personality_quiz
}